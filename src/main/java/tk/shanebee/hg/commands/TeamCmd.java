...
public class TeamCmd extends BaseCmd {
    ...
    @Override
    public boolean run() {
        //TODO: Enable team cmd before the arena start and keep the team over sesions.
        //TODO: When someone enters a team tp him to the leader spawn point
        ...
        if (args[1].equalsIgnoreCase("create")) {
            ...
            //TODO: Move him to the leader spawn point
            //PlayerData data = new PlayerData(Bukkit.getPlayer(team.getLeader()), game);
            ...
            //TODO: Enable auto chosen teams
            if(args.length == 3){
                try{
                    HG.getPlugin().setTeamSize(Integer.parseInt(args[2]));
